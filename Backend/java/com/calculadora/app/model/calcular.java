...
public class calcular {
	...
	public Object[] calcularHoras(Object[] fechas) {
		...
		for (int i = 1; i < fechas.length; i=i+2) {
			fechaInicio = LocalDateTime.parse(fechas[i].toString(), DateTimeFormatter.ofPattern("yyyy-MM-dd'T'HH:mm:ss"));
			fechaFin = LocalDateTime.parse(fechas[i+1].toString(), DateTimeFormatter.ofPattern("yyyy-MM-dd'T'HH:mm:ss"));
